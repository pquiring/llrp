...
/**
 * LLRPConnection represents an abstract interface for an LLRP connection at a LLRP reader or client. The actual implementation differ depending on whether it is a self-initiated
 * connection or a remotely initiated connection.
 */
