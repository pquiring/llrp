 ...
 * <p>
 * <code> LLRPAcceptor c = new LLRPAcceptor(endpoint); </code>
 * <p>
 * <code> c.bind(); </code>
 * <p>
 * <code> // wait for incoming reader initiated connection ..... </code>
 * <p>
 * <code> // send message asynchronously </code>
 * <p>
 * <code> c.send(llrpmessage); </code>
 * <p>
 * <code> // asynchronously LLRP messages arrive via LLRPEndpoint.messageReceived</code>
 * <p>
...
public class LLRPAcceptor extends LLRPConnection {
  ...
  /**
   * binds the LLRPIOHandler registered to the port specified. It does not wait for an incoming READER_NOTIFICATION message with a successful ConnectionAttemptEvent. Use the bind
   * method where you can specify a timeout instead.
   */
  ...
  /**
   * binds the LLRPIOHandler registered to the port specified. The bind method waits for an incoming READER_NOTIFICATION message with a successful ConnectionAttemptEvent for the
   * timeout specified. If the timeout is set to zero, the bind method will not wait for an incoming READER_NOTIFICATION message.
   *
   * @param timeout time in ms
   * @throws LLRPConnectionAttemptFailedException if ConnectionAttemptStatus 'Success' in READER_NOTIFICATION message is not received within time interval specified by timeout
   */
