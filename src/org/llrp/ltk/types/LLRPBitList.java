...
public class LLRPBitList {
   ...
   *
   * @param number of bits to add at front
   */
   ...
   *
   * @param position start at index 0
   */
   ...
   *
   * @param from where sublist starts, list start at Index 0
   * @param subLength long sublist is
   *
  ...
  public byte[] toByteArray() {
    ...
    for (int i = 0; i < nOFb; i++) {
      result[i] = new SignedByte(subList(8 * i, 8)).toByte();
    }
