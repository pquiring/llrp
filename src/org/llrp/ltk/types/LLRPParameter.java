...
/**
 * Representing an LLRPParameter uniquely identified by its type number. Call empty constructor to create new parameter. Use constructor taking LLRPBitList or byte[] as a parameter
 * to instantiate parameter from binary encoding. Use constructor taking JDOM element (www.jdom.org) to create parameter from XML encoding See also TLVParameter and TVParameter
 *
