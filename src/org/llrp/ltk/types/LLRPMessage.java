 ...
 * <p>
 * The binary encoding Is always: Reserved(3 Bits) | Version (3 Bits) | Message Type (10 Bits) | Message Length (32 Bits) | Parameters
 *
 * call empty constructor to create new message. Use constructor taking LLRPBitList or Byte[] to create message from binary encoded message. Use constructor with JDOM document as a
 * parameter to create message from XML encoding
 *
...
public abstract class LLRPMessage {
   ...
   *
   * @throws InvalidLLRPMessageException if bitstring is not well formatted or has any other error
   */
   ...
   * setMessageID.
   *
   * @param messageID of type UnsignedInteger
   */
   ...
   *
   * @param result LLRPBitList to finalize
   */
