...
public class UTF8String extends LLRPType {
   ...
   *
   * This method will check the supplied string to see if it only contains characters allowed by the XML 1.0 specification. The C0 controls (e.g. null, vertical tab, formfeed,
   * etc.) are removed except for carriage return, linefeed and the horizontal tab. Surrogates will throw an IllegalDataException.
   *
   * Note that characters like " and < are allowed in attribute values and element content. They will simply be escaped when the value is serialized.
   *
