 ...
 * Bits) | Parameter Length (16 Bits) | Parameters
 *
 * @author gasserb
 */
public abstract class TLVParameter extends LLRPParameter {
   ...
   *
   * @throws IllegalArgumentException in case of any error or unexpected behaviour
   */
  ...
  /**
   * finalize encoding by setting length of parameter Must be called at very end since length can not be known before message is completly encoded
   *
