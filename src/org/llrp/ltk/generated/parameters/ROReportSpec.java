...
/**
 * This Parameter carries the Reader inventory and RF survey reporting definition for the antenna. This parameter describes the contents of the report sent by the Reader and
 * defines the events that cause the report to be sent.The ROReportTrigger field defines the events that cause the report to be sent.The TagReportContentSelector parameter defines
 * the desired contents of the report. The ROReportTrigger defines the event that causes the report to be sent by the Reader to the Client.See section 13.2.6.1 for details about
 * the order that reports are to be sent with respect to Reader event notifications.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=78&view=fit">LLRP Specification Section 13.2.1</a>} and {@link
...
public class ROReportSpec extends TLVParameter {
  ...
  private static final Logger LOGGER = LogManager.getLogger(ROReportSpec.class);
