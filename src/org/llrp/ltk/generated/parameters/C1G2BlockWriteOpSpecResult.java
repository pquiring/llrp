...
/**
 * Contains the result of a block write operationReaders that do not support C1G2 Block Write SHALL set CanSupportBlockWrite to false in C1G2LLRPCapabilities. If such a Reader
 ...
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=113&view=fit">LLRP Specification Section 15.2.1.5.5.6</a>} and {@link
...
public class C1G2BlockWriteOpSpecResult extends TLVParameter
  ...
  private static final Logger LOGGER = LogManager.getLogger(C1G2BlockWriteOpSpecResult.class);
