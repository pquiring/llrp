...
/**
 * This Parameter carries the RF receiver information. The Receiver Sensitivity defines the sensitivity setting at the receiver. The value is the index into the
 * ReceiveSensitivityTable (section 9.2.1.1).
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=74&view=fit">LLRP Specification Section 12.2.6.1</a>} and {@link
...
public class RFReceiver extends TLVParameter {
  ...
  private static final Logger LOGGER = LogManager.getLogger(RFReceiver.class);
