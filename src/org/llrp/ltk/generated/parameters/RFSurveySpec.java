...
/**
 * This parameter defines RF Survey operations. RF Survey is an operation during which the Reader performs a scan and measures the power levels across a set of frequencies at an
 * antenna. This parameter defines the identifier of the antenna where this survey is to be performed, the duration of the survey operation (specified via stop trigger), and the
 * range of frequencies to measure power levels of.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=59&view=fit">LLRP Specification Section 10.2.3</a>} and {@link
...
public class RFSurveySpec extends TLVParameter implements SpecParameter {
  ...
  private static final Logger LOGGER = LogManager.getLogger(RFSurveySpec.class);
