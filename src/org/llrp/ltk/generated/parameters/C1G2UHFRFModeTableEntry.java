...
/**
 * This parameter carries the information for each UHFC1G2 RF mode. A mode that has been tested for conformance by the EPCGlobal Hardware Action Group's Testing and Conformance
 * (HAG T and C) group, is indicated using a conformance flag.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=99&view=fit">LLRP Specification Section 15.2.1.1.2.1</a>} and {@link
...
public class C1G2UHFRFModeTableEntry extends TLVParameter {
  ...
  private static final Logger LOGGER = LogManager.getLogger(C1G2UHFRFModeTableEntry.class);
