...
/**
 * MB is the memory bank to use. WordPtr is the starting word address. Word Count is the number of 16-bit words to be read. Access Password is the password used by the Reader to
 * transition the tag to the secure state so that it can erase protected tag memory regions.Readers that do not support C1G2BlockErase SHALL set CanSupportBlockErase to false in
 ...
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=109&view=fit">LLRP Specification Section 15.2.1.3.2.5</a>} and {@link
...
public class C1G2BlockErase extends TLVParameter implements AccessCommandOpSpec {
  ...
  private static final Logger LOGGER = LogManager.getLogger(C1G2BlockErase.class);
