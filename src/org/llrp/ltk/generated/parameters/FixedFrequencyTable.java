...
/**
 * This parameter carries the fixed frequency list that can be used by the Reader. The one-based position of a frequency in the list is defined as its ChannelIndex (i.e. the first
 * frequency is referred to as ChannelIndex one).
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=50&view=fit">LLRP Specification Section 9.2.4.1.2.2</a>} and {@link
...
public class FixedFrequencyTable extends TLVParameter {
  ...
  private static final Logger LOGGER = LogManager.getLogger(FixedFrequencyTable.class);
