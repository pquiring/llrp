...
/**
 * This is the response by the Reader to a DELETE_ROSPEC command. If there was a ROSpec corresponding to the ROSpecID that the Reader was presently executing, and the Reader was
 * successful in stopping that execution, then the success code is returned in the LLRPStatus parameter. If there is an error, the appropriate error code is returned in the
 * LLRPStatus parameter.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=52&view=fit">LLRP Specification Section 10.1.4</a>} and {@link
...
public class DELETE_ROSPEC_RESPONSE extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(DELETE_ROSPEC_RESPONSE.class);
