...
/**
 * This is the response by the Reader to a GET_ROSPECS command. If there are no ROSpecs configured at the Reader, the response is just the LLRPStatus parameter with the success
 * code. Else, a list of ROSpec parameter is returned by the Reader, along with the success code in the LLRPStatus parameter.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=55&view=fit">LLRP Specification Section 10.1.14</a>} and {@link
...
public class GET_ROSPECS_RESPONSE extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(GET_ROSPECS_RESPONSE.class);
