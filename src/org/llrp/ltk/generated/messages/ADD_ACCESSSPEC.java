...
/**
 * This command creates a new AccessSpec at the Reader. The AccessSpec starts at the Disabled state waiting for the ENABLE_ACCESSSPEC message for the AccessSpec from the Client,
 * upon which it transitions to the Active state. The AccessSpecID is generated by the Client.The Client SHALL add an AccessSpec in a Disabled State i.e., CurrentState field in the
 * AccessSpec Parameter (section 11.2.1) SHALL be set to false. If the CurrentState value is different than false, an error SHALL be returned in the ADD_ACCESSSPEC_RESPONSE (e.g.
 * P_FieldError).
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=60&view=fit">LLRP Specification Section 11.1.1</a>} and {@link
...
public class ADD_ACCESSSPEC extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(ADD_ACCESSSPEC.class);
