...
/**
 * This message is issued by the Client to the Reader. Upon receiving the message, the Reader moves the ROSpec corresponding to the ROSpecID passed in this message to the disabled
 * state.ROSpecID: If set to Zero, all ROSpecs are disabled.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=54&view=fit">LLRP Specification Section 10.1.11</a>} and {@link
