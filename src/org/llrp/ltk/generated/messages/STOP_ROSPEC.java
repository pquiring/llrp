...
/**
 * This message is issued by the Client to the Reader. Upon receiving the message, the Reader stops the execution of the ROSpec corresponding to the ROSpecID passed in this
 * message. STOP_ROSPEC overrides all other priorities and stops the execution. This basically moves the ROSpec's state to Inactive. This message does not the delete the
 * ROSpec.ROSpecID: Zero is disallowed.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=53&view=fit">LLRP Specification Section 10.1.7</a>} and {@link
...
public class STOP_ROSPEC extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(STOP_ROSPEC.class);
