...
/**
 * This is the response by the Reader to a CLOSE_CONNECTON command from the Client. Upon receiving a CLOSE_CONNECTION command, the Reader SHALL attempt to send this response to the
 * Client. After attempting to send this response, the Reader SHALL close its connection with the Client.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=71&view=fit">LLRP Specification Section 12.1.6</a>} and {@link
...
public class CLOSE_CONNECTION_RESPONSE extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(CLOSE_CONNECTION_RESPONSE.class);
