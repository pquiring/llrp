...
/**
 * This message is issued by the Client to the Reader. Upon receiving the message, the Reader stops the execution of the AccessSpec corresponding to AccessSpecID in this message.
 * This basically moves the AccessSpec's state to Disabled. This message does not delete the AccessSpec. The AccessSpec will stop taking effect from the next inventory
 * round.AccessSpecID: If set to zero, all AccessSpecs are disabled.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=62&view=fit">LLRP Specification Section 11.1.7</a>} and {@link
...
public class DISABLE_ACCESSSPEC extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(DISABLE_ACCESSSPEC.class);
