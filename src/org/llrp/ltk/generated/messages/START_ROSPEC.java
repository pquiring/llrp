...
/**
 * This message is issued by the Client to the Reader. Upon receiving the message, the Reader starts the ROSpec corresponding to ROSpecID passed in this message, if the ROSpec is
 * in the enabled state.ROSpecID: Zero is disallowed.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=52&view=fit">LLRP Specification Section 10.1.5</a>} and {@link
...
public class START_ROSPEC extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(START_ROSPEC.class);
