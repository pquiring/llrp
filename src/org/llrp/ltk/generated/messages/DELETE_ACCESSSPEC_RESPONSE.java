...
/**
 * This is the response by the Reader to a DELETE_ACCESSSPEC command. If there was an AccessSpec at the Reader corresponding to the AccessSpecID passed in the DELETE_ACCESSSPEC
 * command, and the Reader was successful in deleting that AccessSpec, then the success code is returned in the LLRPStatus parameter. If there is an error, the appropriate error
 * code is returned in the LLRPStatus parameter.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=61&view=fit">LLRP Specification Section 11.1.4</a>} and {@link
...
public class DELETE_ACCESSSPEC_RESPONSE extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(DELETE_ACCESSSPEC_RESPONSE.class);
