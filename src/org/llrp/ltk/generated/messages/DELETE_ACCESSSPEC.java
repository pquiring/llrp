...
/**
 * This command is issued by the Client to the Reader. The Reader deletes the AccessSpec corresponding to the AccessSpecId, and this AccessSpec will stop taking effect from the
 * next inventory round.AccessSpecID: If set to Zero, all AccessSpecs are deleted.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=61&view=fit">LLRP Specification Section 11.1.3</a>} and {@link
...
public class DELETE_ACCESSSPEC extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(DELETE_ACCESSSPEC.class);
