...
/**
 * This message is issued by the Client to the Reader. Upon receiving the message, the Reader moves the ROSpec corresponding to the ROSpecID passed in this message from the
 * disabled to the enabled state.ROSpecID: If set to zero, all ROSpecs are enabled.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=53&view=fit">LLRP Specification Section 10.1.9</a>} and {@link
...
public class ENABLE_ROSPEC extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(ENABLE_ROSPEC.class);
