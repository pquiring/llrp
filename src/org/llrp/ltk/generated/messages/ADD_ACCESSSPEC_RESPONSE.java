...
/**
 * This is the response by the Reader to an ADD_ACCESSSPEC command. If the parameters passed in that ADD_ACCESSSPEC command were successfully accepted and set at the Reader, then
 * the success code is returned in the LLRPStatus parameter. However, if the AccessSpec was not successfully created at the Reader, the Reader sends a LLRPStatus parameter
 * describing the error in the message.
 *
 * See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=61&view=fit">LLRP Specification Section 11.1.2</a>} and {@link
...
public class ADD_ACCESSSPEC_RESPONSE extends LLRPMessage {
  ...
  private static final Logger LOGGER = LogManager.getLogger(ADD_ACCESSSPEC_RESPONSE.class);
