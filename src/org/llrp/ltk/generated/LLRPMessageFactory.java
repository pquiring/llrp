...
/**
 *
 * LLRPMessageFactory generates LLRPMessage objects from LLRP Messages in binary or LTK XML encoding.
 *
 * LLRPMessageFactory detects the message types in a binary or XML message and instantiates the corresponding LTK Java message object, e.g. ADD_ROSPEC. The static factory methods
 * return the abstract LLRPMessage.
 *
...
public class LLRPMessageFactory {
   ...
   *
   * @param bits LLRPBitList of a LLRPMessage
   * @return appropriate LLRPMessage out of the given LLRPBitList or null when Message couldn't be generated
   */
   ...
   *
   * @param byteArray byte[] of a LLRPMessage
   * @return appropriate LLRPMessage out of the given byte[] or null when Message couldn't be generated
   */
